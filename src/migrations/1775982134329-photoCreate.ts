...
export class PhotoCreate1775982134329 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `COMMENT ON COLUMN "article"."banner_id" IS '封面海报id'`,
    );
    await queryRunner.query(
      `ALTER TABLE "sys_user" ADD CONSTRAINT "FK_488e98a383c0d563a55df397e17" FOREIGN KEY ("avatar_id") REFERENCES "photo"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "article" ADD CONSTRAINT "FK_47c5095cedb7abb39090e02427b" FOREIGN KEY ("banner_id") REFERENCES "photo"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "article" DROP CONSTRAINT "FK_47c5095cedb7abb39090e02427b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sys_user" DROP CONSTRAINT "FK_488e98a383c0d563a55df397e17"`,
    );
    await queryRunner.query(
      `COMMENT ON COLUMN "article"."banner_id" IS '封面海报id'`,
    );
